...
I have only removed a few blocks of code that specified the target file extensions foand added the config.ini file with the ```[interactive channels]``` option included.
**Credit: Seklfreak**
